...
function Edit(props) {
  ...
  const [is_loading, setLoader] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  const [loading_msg, set_loading_message] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)('');
  window.addEventListener('screenshotReady', updateMedia);
  async function updateMedia(e) {
    if (window.currentScreenToEdit === e.detail) return;
    window.currentScreenToEdit = e.detail;
    e.stopPropagation();
    set_loading_message('Ajout du screenshot en tant que thumbnail...');
    wp.data.dispatch("core/editor").editPost({
      'featured_media': window.currentScreenToEdit
    });
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps)(), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.TextControl, {
    placeholder: "saisissez l'url du site",
    label: "Url du site",
    value: urlValue,
    onChange: updateMetaValue
  }), is_loading ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, loading_msg) : (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    onClick: () => {
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)('ys-annuaire/site-url', {
  /**
   * @see ./edit.js
   */
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunksite_url"] = self["webpackChunksite_url"] || [];
